...
class _PackageWidgetState extends State<PackageWidget> {
      ...
      children: [
        ...
        ListView.builder(
          ...
          itemBuilder: (context, index) {
            ...
            return _buildPackageCard(context, inventoryProvider, package);
          },
        ),
      ],
    );
  ...
  Widget _buildPackageCard(
      BuildContext context, InventoryProvider provider, PackageModel package) {
    return Card(
      color: Colors.white,
      ...
      child: ListTile(
        ...
        title:
            Text(package.name, style: Theme.of(context).textTheme.bodyMedium),
                ...
                child: Row(
                  ...
                  children: [
                    ...
                    IconButton(
                      ...
                      onPressed: () =>
                          _confirmDeletePackage(context, provider, package.id),
                    ),
                  ],
                ),
              )
